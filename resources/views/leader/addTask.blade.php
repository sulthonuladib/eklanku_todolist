    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card card-new-task">
                <div class="card-header">New Task<div class="float-right"><a href="{{ url()->previous() }}" class="btn btn-sm btn-danger"><i class="fa fa-times" aria-hidden="true"></i></a></div></div>

                <div class="card-body">
                    <form method="POST" action="{{url('/')}}/leader/store" enctype="multipart/form-data">
                        @csrf
