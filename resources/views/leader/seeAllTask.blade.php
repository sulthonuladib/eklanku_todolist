                ...
                <div class="card-body">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col">
                                <div class="card">
                                <div class="uid card-header">Planning</div>                                   
                                    <div class="card-body">
                                        <div id="pl" class="droppable">
                                            <div class="sort text-row">
                                            @foreach($task as $tasknyaa)
                                                @if($tasknyaa->keterangan==0)    
                                                <a href="{{url('/')}}/member/detail/{{$tasknyaa->id}}" id="{{$tasknyaa->id}}" class="draggable list m-1">{{$tasknyaa->title}}<span class="ml-2 badge badge-light">{{$tasknyaa->name}}</span></a>
                                                @endif
                                            @endforeach
                                            </div>
                                        </div>
                            ...
                            <div class="col">
                                <div class="card">
                                <div class="uid card-header">Merge</div>                                   
                                    <div class="card-body">
